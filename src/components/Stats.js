var Stats = (props) => {
    return (
        <div className="card stat-card mx-4 p-4">
            ...
            <p><b>Avg. attack: </b>{props.stats.averageStats.attack}/<b>{(1023 * props.stats.currentPopulation)/props.stats.population}</b></p>
            <p><b>Avg. health: </b>{props.stats.averageStats.health}/<b>{(1023 * props.stats.currentPopulation)/props.stats.population}</b></p>
